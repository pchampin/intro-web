...
html_title = "Introduction au Web"  ## overridden to remove "documentation"
...
\DeclareUnicodeCharacter{26A0}{/!\textbackslash}

%% prevent figures to float around
%% seen here: http://svn.opengeo.org/workshops/projects/geoext/generic_1.1/src/doc/conf.py
\usepackage{float}
...
man_pages = [
    ('index', 'xxxyyyzzz', u'Introduction au Web',
     [u''], 1)
]
